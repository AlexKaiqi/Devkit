...
用 Playwright 模拟 iPhone/Android 视口，验证页面加载和基础 API 可用性。

运行:
  .venv/bin/python -m pytest implementation/tests/mobile/test_opencami.py -v
"""
...
BASE_URL = os.environ.get("FENGLING_URL", "http://localhost:3001")
...
class TestFenglingApi:
    def test_voices_endpoint(self):
        ...
        assert "voices" in data, f"voices endpoint failed: {data}"
